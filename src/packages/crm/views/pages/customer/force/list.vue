...
<script>
import { getForceList } from '@/api/potential'
...
export default {
  ...
  async: {
    initData() {
      return Promise.all([this.getForceList()])
    },
    getForceList() {
      return getForceList(this.$searchQuery).then(res => {
