<template>
  <oa-modal
    ...
    v-model="show"
    @ok="onSubmit"
    :confirmLoading="translate$loading"
  >
    <a-spin :spinning="getTranslateTag$loading">
      <p class="mg-t24 ta-c">
        是否将
...
<script>
import { getTranslateTag, translate } from '@/api/leads'
...
export default {
  ...
  async: {
    getTranslateTag() {
      return getTranslateTag().then(res => {
