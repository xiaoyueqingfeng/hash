    ...
    <div class="http404">
      ...
      <div class="bullshit">
        ...
        <div class="bullshit__info">
          版权所有
          <router-link to="/" class="color-theme">{{ $platform }}</router-link>
        </div>
...
<script>
import img404 from 'oa-core/assets/img/bg_404.png'
import img404Cloud from 'oa-core/assets/img/bg_cloud.png'
